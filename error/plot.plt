...
#    	System: Linux 2.6.20-16-generic
#    
...
set yrange [ * : * ] noreverse nowriteback  # (currently [:10.0000] )
...
plot 'data.dat' u 1:2:3:4 every ::1 w xyerrorbars, 'error.dat' every ::1 with points
pause -1
#    EOF
