...
#    	System: Linux 2.6.20-17-generic
#    
...
set yrange [ 95.0000 : 105.000 ] noreverse nowriteback
...
plot "result.dat" u 1:2 w lines, "result.dat" u 1:($2 -$3), "result.dat" u 1:($2 + $3), "result.dat" u 1:4:5 w yerrorbar lt -1, 100 lt -1
#    EOF
